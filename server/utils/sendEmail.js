...
const { AUTH_EMAIL, AUTH_PASSWORD, APP_URL_C, APP_URL_S } = process.env;

// Looking to send emails in production? Check out our Email API/SMTP product!
const transporter = nodemailer.createTransport({
	host: "smtp.gmail.com", // Use full SMTP address
	port: 587,
	secure: false, // true for 465, false for other ports
	auth: {
		user: "oggykhaan@gmail.com",
		pass: "knao okkx aqzl skck", // Your app password
	},
	tls: {
...
export const sendVerificationEmail = async (user, res) => {
	...
	const link = APP_URL_S + "users/verify/" + _id + "/" + token;
